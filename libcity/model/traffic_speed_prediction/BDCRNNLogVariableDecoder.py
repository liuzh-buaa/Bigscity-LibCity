...
from libcity.model.traffic_speed_prediction.BDCRNNBase import EncoderSigmaModel, DecoderSigmaModel, BDCRNNBase
from libcity.model.traffic_speed_prediction.layers.functions import count_parameters


class BDCRNNLogVariableDecoder(BDCRNNBase):
    def __init__(self, config, data_feature):
        super(BDCRNNLogVariableDecoder, self).__init__(config, data_feature)
