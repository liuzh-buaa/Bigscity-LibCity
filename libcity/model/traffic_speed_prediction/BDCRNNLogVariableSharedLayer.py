...
class BDCRNNLogVariableSharedLayer(BDCRNNBase):
    def __init__(self, config, data_feature):
        super(BDCRNNLogVariableSharedLayer, self).__init__(config, data_feature, True)
    ...
    def forward(self, batch, batches_seen=None):
        ...
        outputs, log_sigma_0 = self.decoder(encoder_hidden_state, labels, batches_seen=batches_seen)
        ...
        log_sigma_0 = log_sigma_0.view(self.output_window, batch_size, self.num_nodes, 1).permute(1, 0, 2, 3)
        return outputs, log_sigma_0
