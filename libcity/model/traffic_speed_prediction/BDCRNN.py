...
class GCONV(nn.Module):
    def __init__(self, num_nodes, max_diffusion_step, supports, device, input_dim, hid_dim, output_dim, bias_start=0.0,
                 sigma_pi=1.0, sigma_pi_start=1.0):
        ...
        torch.nn.init.constant_(self.log_sigma_weight, math.log(sigma_pi_start))
        torch.nn.init.constant_(self.log_sigma_bias, math.log(sigma_pi_start))
...
class BDCRNN(AbstractTrafficStateModel, Seq2SeqAttrs):
