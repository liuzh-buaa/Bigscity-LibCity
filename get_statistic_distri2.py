"""
    python get_statistic_distri2.py --task traffic_state_pred --model BDCRNNVariableDecoder --dataset METR_LA --model_cache_id 77290 --gpu_id 0
    python get_statistic_distri2.py --task traffic_state_pred --model BDCRNNVariableDecoderShared --dataset PEMS_BAY --model_cache_id 42464
"""
import argparse
import os
import random
...
if __name__ == '__main__':
    ...
    executor.testing2(test_data, args.start, args.end, config.get('output_window'), config.get('output_dim'),
